...
INSERT INTO visits (pet_id, vet_id, visit_date, start_time, description) SELECT 7, 1, '2010-03-04', '09:00:00', 'rabies shot' WHERE NOT EXISTS (SELECT * FROM visits WHERE id=1);
INSERT INTO visits (pet_id, vet_id, visit_date, start_time, description) SELECT 8, 2, '2011-03-04', '10:30:00', 'rabies shot' WHERE NOT EXISTS (SELECT * FROM visits WHERE id=2);
INSERT INTO visits (pet_id, vet_id, visit_date, start_time, description) SELECT 8, 3, '2009-06-04', '14:00:00', 'neutered' WHERE NOT EXISTS (SELECT * FROM visits WHERE id=3);
INSERT INTO visits (pet_id, vet_id, visit_date, start_time, description) SELECT 7, 4, '2008-09-04', '15:30:00', 'spayed' WHERE NOT EXISTS (SELECT * FROM visits WHERE id=4);
